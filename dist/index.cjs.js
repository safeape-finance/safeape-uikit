...
var StyledToggle = styled__default['default'].div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: ", "px;\n  position: relative;\n  transition: background-color 200ms;\n  width: ", "px;\n"], ["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: ", "px;\n  position: relative;\n  transition: background-color 200ms;\n  width: ", "px;\n"])), function (_a) {
    ...
    var scale = _a.scale;
    return scale === "lg" ? 40 : 20;
}, function (_a) {
    var scale = _a.scale;
    return scale === "lg" ? 72 : 40;
});
var templateObject_1$t, templateObject_2$8, templateObject_3$4;

var Toggle = function (_a) {
    var checked = _a.checked, _b = _a.scale, scale = _b === void 0 ? "lg" : _b, props = __rest(_a, ["checked", "scale"]);
...
var RugDocAudit = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement("image", { width: "128", height: "128", href: '/images/menu/arena-icon.png' })));
};
...
var Icon$K = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement("image", { width: "128", height: "128", href: "/images/menu/field-icon.png" })));
};

var Icon$L = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/menu/game-icon.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 650 191" }, props),
        React__default['default'].createElement("image", { width: "650", height: "191", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/SafeApeChat"
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/CaptainsCryptos",
    }
    // ,
    // {
    //   label: "Reddit",
...
var RugDocAuditButton = function (_a) {
    ...
    return (React__default['default'].createElement(StyledAudit, null,
        React__default['default'].createElement("a", { href: auditLink, "aria-label": "AuditLink", target: "_blank" },
            React__default['default'].createElement(RugDocAudit$1, null))));
};
var templateObject_1$D;
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, rugDocLink = _a.rugDocLink, profile = _a.profile, children = _a.children;
